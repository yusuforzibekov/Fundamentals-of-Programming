# Gradually Decreasing Carousel Plus
...
and [`GraduallyDecreasingCarouselRun`](src/main/java/com/epam/rd/autotasks/GraduallyDecreasingCarouselRun.java).
The subclass `GraduallyDecreasingCarouselRun` must decrement elements 
by gradually increasing decrement.
